...
<div class="fs0 orc_pag" style="margin-top: 150px;">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" maxlength="9" id="telemovel" name="telemovel" placeholder="Telefone.." required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="codpost" name="codpost" placeholder="Código-Postal.." style="width: 200px;" required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <textarea id="mensagem" name="mensagem" placeholder="Escreva a sua proposta..." style="height:200px" required></textarea>
    </div>
  </div>
