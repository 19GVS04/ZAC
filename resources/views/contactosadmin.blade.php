...
<head>
    ...
    <link rel="stylesheet" href="/css/contactosadmin.css">
      ...
      <div class="right">
        <form method="post" action="{{route('contactos.store')}}">
          @csrf	
				...
				<select class="field" aria-label="Default select example" disabled>
        ...
        <div>
          <input type="text" id="nome" name="nome" class="field" placeholder="{{ $contacto->nome}}" disabled>
        </div>
          <input type="text" name="email" class="field" placeholder="{{ $contacto->email}}" disabled>
				<input type="text" maxlength="9" name="telefone" class="field" placeholder="{{ $contacto->telefone}}" disabled>
				<textarea name="mensagem" placeholder="{{ $contacto->mensagem}}" class="field" disabled></textarea>
        <textarea name="resposta" placeholder="Introduza a sua resposta.." class="field" required></textarea>
